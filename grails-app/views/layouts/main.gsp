        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <sec:ifAnyGranted roles="ROLE_ADMIN">
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="/contenedor/contenedorIndex"><i class="fa fa-circle-o"></i> Contenedor</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/muestra/seleccionarDispositivoIndex"><i class="fa fa-circle-o"></i> Ver dispositivos </a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/pais/paisIndex"><i class="fa fa-circle-o"></i> Pais </a></li>
